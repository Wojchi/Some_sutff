...
import { Zap, ArrowRight, Bot, Cpu, Database, Clock } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Automate repetitive tasks with intelligent AI systems"
    },
    {
      icon: <Cpu className="w-6 h-6 text-red-500" />,
      title: "Smart Workflows",
      description: "AI-powered workflow optimization and management"
    },
    {
      icon: <Database className="w-6 h-6 text-red-500" />,
      title: "Data Processing",
      description: "Automated data analysis and processing capabilities"
    },
    {
      icon: <Clock className="w-6 h-6 text-red-500" />,
      title: "Time Optimization",
      description: "Reduce manual work hours with intelligent automation"
    }
  ];
  ...
  const steps = [
    {
      ...
      description: "Identifying automation opportunities in your workflow"
    },
    {
      number: "02",
      title: "Solution Design",
      description: "Creating custom automation solutions for your needs"
    },
    {
      number: "03",
      title: "Implementation",
      description: "Deploying and integrating automation systems"
    },
    {
      number: "04",
      title: "Optimization",
      description: "Continuous improvement of automated processes"
    }
  ];
        ...
        <div className="container mx-auto px-4 py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300">
              Streamline your business processes with intelligent automation that learns and adapts
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto glass-effect p-8 rounded-2xl">
            ...
            <p className="text-gray-300 mb-6">
              Our AI Automation service transforms your business operations by implementing intelligent systems that automate repetitive tasks, optimize workflows, and enhance productivity. We leverage cutting-edge AI technology to create custom automation solutions that adapt to your specific needs.
            </p>
            <p className="text-gray-300">
              From simple task automation to complex workflow optimization, our solutions help you reduce manual effort while improving accuracy and efficiency.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 relative">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center glass-effect p-12 rounded-2xl">
            <h2 className="text-4xl font-bold mb-6 gradient-text">Automate Your Business</h2>
